...
function renderResult() {
  ...
  <div class="panel fade-in" style="margin-top:24px;text-align:center;">
    <span style="display:inline-flex;align-items:center;justify-content:center;gap:8px;">
      ...
      <a href="https://px.a8.net/svt/ejp?a8mat=4B3YV8+F171O2+4GRI+BW8O2&a8ejpredirect=https%3A%2F%2Fstore.fits-japan.com%2Fshop%2Fproduct_categories%2Fpuananala" rel="nofollow" style="color:#0066cc;">あなたにおすすめの香水を見つける</a>
    </span>
    <p style="margin:8px 0 0;font-size:11px;color:var(--text-sub);">このリンクには広告が含まれます</p>
